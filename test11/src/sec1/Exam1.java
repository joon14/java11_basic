...
public class Exam1 {
	public static void main(String[] args) {
		...
		String s1 = "jdj";						//기본형X, 참조형X
		String s2 = "jdj";						//기본형X, 참조형X
		System.out.println("s1==s2 : "+(s1==s2));				//★ 틀린 문자열의 값 비교
		System.out.println("s1 equals s2 : "+s1.equals(s2));	//★ 맞는 문자열의 값 비교 -> String 클래스 연산을 해야 하므로 반드시 equals 를 사용해야한다.
		...
		System.out.println("c equals d : "+c.equals(d));	//참조형의 비교는 equals 로 해야함
	}
}
