...
public class ScopeExam {
	...
	public static void main(String[] args) {
		int a = 20;	//지역 변수 : 특정 메소드(함수)내에서만 선언되어 활용되는 변수로서 함수 블록을 벗어나면, 인지할 수 없음. => Local Scope
	...
	public static void run(int a) {	//매개 변수 : 메소드(함수) 정의 시 괄호 안에 있는 변수로 호출 시 지정된 값을 저장한다. => Local Scope
