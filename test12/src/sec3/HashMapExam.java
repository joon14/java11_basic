...
//3. 비선형 구조 : 맵(Map), 트리(Tree), 그래프(Graph), 셋(Set)
public class HashMapExam {
	public static void main(String[] args) {
		//선언 방법
		Map<String, String> map0 = new HashMap<String, String>();	//Map 인터페이스를 활용한 HashMap 생성
		HashMap<String, String> map1 = new HashMap<>();				//HashMap 선언 및 생성 표준식
		...
		//초기 용량 지정(capacity) - 초기 용량 지정보다 더 많은 데이터를 저장하게 되면, 자동적으로 초기 용량의 배로 증가함.
		HashMap<String, String> map4 = new HashMap<>(10);
		HashMap<String, String> map5 = new HashMap<>(10, 0.7f);		//0.7f = load factor : 사용 확률 지정
		HashMap<String, String> map6 = new HashMap<>() {{			//기본 key 와 그에 해당하는 값을 적용하여 HashMap 생성
			put("name", "jung");	
		}};
		...
		System.out.println("변경 전 : "+fruits);
		fruits.remove(6);
		System.out.println("변경 후 : "+fruits);
		//fruits.clear();
